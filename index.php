          ...
          <div class="information__card--table">
            <table>
              <tbody>
                ...
                <tr class="information__card--text1">
                  <td class="information__card--left">一時利用<br /></td>
                  <td class="information__card--right">2,500円/1回（3時間）</td>
                </tr>
    ...
    <section class="message" id="message">
      <div class="message__inner">
        ...
        <div class="message__text">
          ...
          自身が3人の子ども達の習い事の送迎に苦労した経験から、自転車で通える範囲に習い事や体験の場があればと考えていました。大人から子供まで新しいことや興味のあることにチャレンジしやすいように住宅地にレンタルスペース宝塚をオープンしました。利用者様には子育てや仕事などで一時的にスキルを眠らせている方などもおられると思います。そのような方にも負担なくお教室を始めていただけるように、希望される方には生徒募集のチラシ作成、ポスティングなど運営面のサポートもしています。教えたいと学びたいを繋ぐ場として、これからも地域の皆さんが気軽に集まり、挑戦できる場を提供していきたいと思っていますので、まずは気軽に見学＆お問い合わせください！
          </p>
        </div>
      </div>
    </section>
